...
<tr><td rowspan="1" style="padding: 14px 16px; vertical-align: middle; font-size: 13px; border: 1px solid #30363d; white-space: nowrap;"><code>vladmandic/sdnext</code></td><td style="padding: 14px 16px; border: 1px solid #30363d;"><a href="https://github.com/vladmandic/sdnext/pull/4961">fix: detect hipBLASLt Tensile library in nested per-arch subfolder</a></td></tr>
